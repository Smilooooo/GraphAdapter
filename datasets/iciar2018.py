...
NEW_CNAMES = {
    ...
    "InSitu":  "Ductal carcinoma in situ",
    "Invasive": "Invasive breast carcinoma"
}

@DATASET_REGISTRY.register()
class ICIAR2018(DatasetBase):
    """
    ICIAR2018 BACH Challenge Dataset (Breast Cancer Histopathology)
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_zhou_ICIAR2018.json")
    ...
    def read_and_split_data(image_dir, p_trn=0.6, p_val=0.2, ignored=[], new_cnames=None):
        ...
        Expected structure:
        image_dir/  (points to BACH/ICIAR2018_BACH_Challenge/Images/)
            Normal/
                img1.jpg
                img2.jpg
            Benign/
