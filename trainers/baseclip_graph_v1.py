...
CUSTOM_TEMPLATES = {
    ...
    "ImageNetR": "a photo of a {}.",
     # custom template for new datasets
    "LungHist700": "a histopathology image of {}.",
    "BRACS": "a histopathology image of {}.",
    "ICIAR2018": "a histopathology image of {}.",
}
...
class GraphConvolution(nn.Module):
    def __init__(self, hidden_dim, name=None, device=None, class_num=None, sparse_inputs=False, act=nn.Tanh, bias=True, dropout=0.0):
        ...
        self.bias = bias
        # Removed hardcoded self.hidden_dim = 512 (use the passed parameter instead)
...
class GraphLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model, base_text_features, base_img_features):
        ...
        self.node_num = 1
        # self.alpha_it = 
        # Use the actual feature dimension from base_text_features (e.g., 1024 for RN50)
        self.hidden_dim = base_text_features.size()[1]
    ...
    def forward(self, img_feature):
        ...
        with torch.no_grad():
            ...
            node_cluster_t = self.base_text_features[:num_to_use].view(1, num_clusters, 4, self.base_text_features.size()[1])
            node_cluster_i = self.base_img_features[:num_to_use].view(1, num_clusters, 4, self.base_img_features.size()[1])
